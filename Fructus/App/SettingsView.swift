            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        ...
                        SettingsRowView(name: "iOS Version", content: "iOS 16.2")
                        SettingsRowView(name: "Website", linkLabel: "SwiftUI", linkDestination: "developer.apple.com/xcode/swiftui/")
                        SettingsRowView(name: "Github", linkLabel: "@PrabhjotCngh", linkDestination: "github.com/PrabhjotCngh")
                        SettingsRowView(name: "SwiftUI Version", content: "4.0")
